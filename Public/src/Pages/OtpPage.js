...
const  OtpPage= () => {
    ...
    const handleSubmit= async(e)=>
    {
        ...
        if(handleValidation())
        {
            ...
            const data = await axios.post(otpSender, 
                ...
                {
                    toast.success("otp Verfication", {toastOption})
    ...
    const handleValidation = ()=>
    {
        const {otp } = values;
         ...
         if(otp === "")
        {
            toast.error("Please Enter Otp", toastOption);
            return false;
        }
  ...
  return (
    ...
    <FormContainer>
      ...
      <div className="brand">
        ...
        <input type="otp" name="otp" id="otp" placeholder='otp' value={values.otp} onChange={handleChange}/>
